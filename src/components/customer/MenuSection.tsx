      ...
      <div className="mx-auto max-w-3xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg font-light text-warm-gray">
            Tap any item to add it to your chat, or ask for the full menu inside the chat.
          </p>
        </div>
        ...
        <div className="mt-10 space-y-10">
          {menu.categories.map((category) => (
            <div key={category.id}>
              <h3 className="mb-4 border-b border-espresso/10 pb-2 font-serif text-2xl font-medium">
                {category.title}
              </h3>
